...
?>
<b>Giá</b><br>
    <select class="selectA" name="giaBanS" id="selectGiaBanS">
    ...
    while ($row = mysqli_fetch_array($query)) {
        $i++;
    ?>
        <input type="radio" name="danhMucS" id="<?php echo $row['idDanhMuc']; ?>" value="<?php echo $row['idDanhMuc']; ?>" <?php if (isset($_GET['danhMuc']) && $_GET['danhMuc'] == $row['idDanhMuc']) echo 'checked' ?>>
        <label for="<?php echo $row['idDanhMuc']; ?>" class="custom-radio"><?php echo $row['tenDanhMuc'] ?></label><br>

        <!-- <a style="color: #5c5c5c;" href="index.php?danhmuc=<?php echo $row['idDanhMuc']; ?>"><?php echo $row['tenDanhMuc'] ?> (<?php echo $row['tongSoLuong'] ?>)</a><br> -->
    <?php } ?>
    ...
    while ($r2 = mysqli_fetch_array($query2)) {
        $i++;
    ?>
        <input type="radio" name="kichCoS" id="<?php echo $r2['kichCo']; ?>" value="<?php echo $r2['kichCo']; ?>" <?php if (isset($_GET['kichCo']) && $_GET['kichCo'] == $r2['kichCo']) echo 'checked' ?>>
        <label for="<?php echo $r2['kichCo']; ?>" class="custom-radio"><?php echo $r2['kichCo']; ?></label><br>

        <!-- <a style="color: #5c5c5c;" href=""><?php echo $r2['kichCo'] ?> (<?php echo $r2['soLuongSize'] ?>)</a><br> -->
    <?php } ?>
